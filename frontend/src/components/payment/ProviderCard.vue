  ...
  >
    <div :class="[
      ...
      <div class="flex items-center gap-4">
        ...
        <ToggleSwitch v-if="provider.provider_key !== 'perpay'" :label="t('admin.settings.payment.refundEnabled')" :checked="provider.refund_enabled" @toggle="emit('toggleField', 'refund_enabled')" />
...
const keyLabel = computed(() => props.provider.provider_key === 'perpay' ? 'PerPay' : t(PROVIDER_KEY_LABELS[props.provider.provider_key] || props.provider.provider_key))
