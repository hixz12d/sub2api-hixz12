  ...
  <AppLayout>
    ...
    >
      ...
      >
        ...
        <ModelsListConfigField v-model="createModelsListConfig" />
    ...
    >
      ...
      >
        ...
        <ModelsListConfigField v-model="editModelsListConfig" />
        <ReasoningEffortPolicyFields
...
import ModelsListConfigField from "@/components/admin/group/ModelsListConfigField.vue";
...
const createModelsListConfig = ref<ModelsListConfig>({ enabled: false, models: [] });
const editModelsListConfig = ref<ModelsListConfig>({ enabled: false, models: [] });
...
const handleCreateGroup = async () => {
  ...
  try {
    ...
    const requestData = {
      ...
      models_list_config: createModelsListConfig.value,
...
const handleEdit = async (group: AdminGroup) => {
  ...
  editModelsListConfig.value = {
    enabled: group.models_list_config?.enabled ?? false,
    models: [...(group.models_list_config?.models ?? [])],
  };
...
const handleUpdateGroup = async () => {
  ...
  try {
    ...
    const payload = {
      ...
      models_list_config: editModelsListConfig.value,
