          ...
          <div class="card">
            ...
            <div class="space-y-4 p-6">
              ...
              <template v-if="form.payment_enabled">
                <div class="flex items-center justify-between gap-4">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-white">{{ t("admin.settings.payment.purchaseEntryEnabled") }}</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ t("admin.settings.payment.purchaseEntryEnabledHint") }}</p>
                  </div>
                  <Toggle v-model="form.payment_purchase_entry_enabled" :aria-label="t('admin.settings.payment.purchaseEntryEnabled')" data-testid="purchase-entry-enabled" />
                </div>
                <div class="flex items-center justify-between gap-4">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-white">{{ t("admin.settings.payment.purchaseEntryPerPayLinked") }}</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ t("admin.settings.payment.purchaseEntryPerPayLinkedHint") }}</p>
                  </div>
                  <Toggle v-model="form.payment_purchase_entry_perpay_linked" :disabled="!form.payment_purchase_entry_enabled" :aria-label="t('admin.settings.payment.purchaseEntryPerPayLinked')" data-testid="purchase-entry-perpay-linked" />
                </div>
                <!-- Row 1: Product name -->
...
import AccountCreateTemplatesPanel from "@/components/account/AccountCreateTemplatesPanel.vue";
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      payment_purchase_entry_enabled: form.payment_purchase_entry_enabled,
      payment_purchase_entry_perpay_linked: form.payment_purchase_entry_perpay_linked,
