...
export default {
  channelMonitorV2: {
    ...
    metrics: {
      ...
      cacheRate: 'Cache read share',
      cacheDetail: 'Existing token accounting basis',
    ...
    settings: {
      cardThresholds: 'Status card response thresholds',
      cardWarning: 'TTFT P90 warning ms',
      cardCritical: 'TTFT P90 critical ms',
      notConfigured: 'Not configured',
      cardThresholdsInvalid: 'Leave both P90 thresholds empty, or set 0 < warning < critical.',
