export default {
    accounts: {
      ...
      createTemplate: {
        ...
        hint: 'Save proxy, WS mode, Codex fingerprint, concurrency, groups, and other create-time defaults as a snapshot. Selecting a template copies it into this form; you can still edit afterwards.',
        ...
        name: 'Template name',
        namePlaceholder: 'e.g. Team rotation',
        includeGroups: 'Include groups',
        includeGroupsHint: 'When off, this template neither stores nor overwrites groups.',
        isDefault: 'Default for this platform and type',
        isDefaultHint: 'Applied automatically when adding an account of this type.',
        applyGroups: 'Also apply groups',
        applyGroupsHint: 'Uncheck to write proxy, WS, fingerprint, and other fields without changing the current groups.',
        preview: 'Will write: {summary}',
      ...
      quotaExemptModels: 'Models Allowed After Limit',
      quotaExemptModelsPlaceholder: 'e.g. gpt-4o, gpt-4o-mini',
      quotaExemptModelsHint: 'Comma or newline separated. These exact models remain callable after the account quota is exhausted.',
      ...
      openai: {
        ...
        codexRelayKernelSectionTitle: 'Codex Relay Kernel',
        codexRelayKernelSectionDesc: 'Version-pinned compatibility profiles; native client transport parity remains unverified.',
        codexRelayMode: 'Relay Architecture Mode',
        codexRelayModeDesc: 'Legacy uses standard passthrough and lightweight convergence; Relay Kernel activates full session isolation, Wire-ID bridge, and protocol fidelity kernel.',
        codexRelayModeLegacy: 'Legacy (Traditional Compatible)',
        codexRelayModeKernel: 'Relay Kernel (Fidelity Kernel)',
        codexRelayKernelBadge: 'Kernel Selected',
        codexIdentityPolicyVersion: 'Session Identity Policy Version',
        codexIdentityPolicyVersionDesc: 'Select upstream session and Wire-ID isolation policy. v1 is traditional coarse-grained; v2 enforces per-session isolation and strict context boundaries. Enforced and locked to v2 under Relay Kernel.',
        codexIdentityPolicyV1: 'v1 (Traditional Coarse-grained Policy)',
        codexIdentityPolicyV2: 'v2 (Fine-grained Session Isolation & Wire-ID, Strongly Consistent)',
        codexClientProfile: 'Client Profile',
        codexClientProfileDesc: 'Configure client profile characteristics when interacting upstream. The system automatically aligns client headers, Wire-ID specs, and protocol degradation.',
        codexClientProfileAuto: 'Auto (Dynamic based on request)',
        codexClientProfilePassthrough: 'Passthrough (Caller supplied)',
        codexClientProfileCodexCli: 'Codex CLI (Official CLI profile 0.148.0)',
        codexClientProfileCodexExec: 'Codex Exec (Official background execution profile 0.148.0)',
        ...
        codexAdvancedConfiguration: 'Advanced and Compatibility',
        codexProfileVariant: 'Version and Variant',
        codexProfileUnknown: 'This historical profile is unsupported. Its value has not been automatically replaced.',
        codexCatalogUnavailable: 'Client catalog unavailable; capabilities are unknown.',
        codexPreviewUnavailable: 'Effective configuration preview unavailable; not verified.',
        codexPreviewOperation: 'Operation',
        codexPreviewTransport: 'Transport',
        codexEffectiveSender: 'Expected Sender',
        codexBundleTLSConflict: 'Shared r1 profiles conflict with TLS impersonation and require it to be explicitly disabled.',
        codexBundleBulkTLSRequired: 'Bulk r1 changes require an explicit TLS impersonation opt-out; unchanged is not disabled.',
        ...
        codexProfileUnverified: 'Unverified',
        codexProfileDegraded: 'Known differences',
        codexProfileSupported: 'Supported',
        codexProfileUnsupported: 'Unsupported',
        codexRelayShadowEnabled: 'Shadow Comparison Observation',
      ...
      groupPriorityTitle: 'Group scheduling priority',
      groupPriorityHint: 'Lower values place the account in an earlier tier for that OpenAI group. Saving uses the current value for conflict detection.',
      groupPriorityLabel: 'Group priority for {group}',
      failedToCreate: 'Failed to create account',
      failedToUpdate: 'Failed to update account',
      accountSavedPriorityUpdateFailed: 'Account saved, but group priority updates conflicted. The latest server state has been reloaded.',
