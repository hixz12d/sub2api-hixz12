    ...
    settings: {
      ...
      features: {
        ...
        channelMonitor: {
          ...
          defaultIntervalHint: 'V1 only: default interval for new monitors (overridable per monitor). Range 15 – 9600 seconds.',
      ...
      payment: {
        ...
        purchaseEntryEnabled: 'Purchase entry',
        purchaseEntryEnabledHint: 'When off, hides recharge/subscription purchases and stops new orders. Existing order queries and payment callbacks continue.',
        purchaseEntryPerPayLinked: 'Link purchase entry to PerPay',
        purchaseEntryPerPayLinkedHint: 'Only open purchases while at least one PerPay provider is enabled. Manually closing the entry takes priority.',
