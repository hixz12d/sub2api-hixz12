export default {
    ...
    riskControl: {
      ...
      savedWithScope: 'Content moderation config saved ({scope})',
      refresh: 'Refresh',
      ...
      auditScopeHint: 'Audit all groups, selected groups, or only requests locally scheduled to selected upstream accounts.',
      ...
      selectedAccountsHint: 'Currently auditing selected upstream accounts',
      savedScopeTargetsHint: 'These are the active audit targets and remain visible on the risk control home page after save.',
      selectedAccountsRequired: 'Select at least 1 account for selected-account scope',
    ...
    channelMonitor: {
      ...
      primaryModelRequired: 'Please select a primary model',
      ...
      form: {
        ...
        primaryModel: 'Primary Model',
        primaryModelPlaceholder: 'Select or search a model',
        useCustomModel: 'Use',
        extraModels: 'Extra Models',
        extraModelsPlaceholder: 'Select or press Enter to add extra model',
        groupName: 'Group Name',
        groupNamePlaceholder: 'Optional, used to group rows in user view',
        intervalSeconds: 'Interval (seconds)',
        intervalSecondsHint: 'Range: 15 - 9600 seconds (up to ~2h 40m)',
        jitterSeconds: 'Random Jitter (± seconds)',
        jitterSecondsHint: 'Recommended 200. Each check fires at interval ± a random offset within this value; 0 means fixed interval. Interval minus jitter must be ≥ 15s',
