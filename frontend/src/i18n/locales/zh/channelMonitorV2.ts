...
export default {
  channelMonitorV2: {
    ...
    metrics: {
      ...
      cacheRate: '缓存读取占比',
      cacheDetail: '现有 token 口径',
      successRate: '成功率',
      successRateValue: '成功率 {value}',
      errorRateValue: '评分错误率 {value}',
      rpmValue: 'RPM {value}',
      tpmValue: 'TPM {value}',
    ...
    settings: {
      cardThresholds: '状态卡片响应阈值',
      cardWarning: 'TTFT P90 关注阈值 ms',
      cardCritical: 'TTFT P90 异常阈值 ms',
      notConfigured: '未设置',
      cardThresholdsInvalid: 'P90 阈值需同时留空，或满足 0 < 关注阈值 < 异常阈值。',
      title: 'V2 数据监控配置',
      description:
