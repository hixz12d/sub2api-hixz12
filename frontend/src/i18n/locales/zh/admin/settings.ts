    ...
    settings: {
      ...
      features: {
        ...
        channelMonitor: {
          ...
          defaultIntervalHint: '仅 V1 模式使用：新建渠道监控时表单的默认值，可被单个渠道覆盖。范围 15 – 9600 秒。',
      ...
      payment: {
        ...
        purchaseEntryEnabled: '站内购买入口',
        purchaseEntryEnabledHint: '关闭后隐藏充值/订阅入口并停止新建订单；已有订单查询和支付回调继续处理。',
        purchaseEntryPerPayLinked: '购买入口随 PerPay 联动',
        purchaseEntryPerPayLinkedHint: '开启后，仅在至少一个 PerPay 服务商启用时开放购买入口；手动关闭入口优先。',
