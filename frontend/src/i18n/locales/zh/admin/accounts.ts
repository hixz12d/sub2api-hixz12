export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，将设备/会话/线程标识收敛为账号级稳定值。thread 是官方当天独立对话数，不是 credits。40 Threads 时段池按 8 小时切换，每个 UTC 日最多 40 条，并按站内用户、API Key 和客户端会话稳定分槽；旧时段池最多 24 条。',
