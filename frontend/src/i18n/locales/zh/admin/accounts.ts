export default {
    accounts: {
      ...
      openai: {
        ...
        codexRelayKernelSectionDesc: '用于 OpenAI OAuth / Codex 上游的协议保真度与会话隔离控制。支持双协议架构，提供官方保真度转发能力。',
        ...
        codexRelayKernelBadge: 'Relay Kernel 已激活',
        ...
        codexProfileAppVersion: '版本',
        codexProfileCapabilities: '协议能力',
        codexProfileFidelity: '保真度',
