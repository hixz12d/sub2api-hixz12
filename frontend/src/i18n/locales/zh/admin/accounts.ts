export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，将设备/会话/线程标识收敛为账号级稳定值，降低上游可见的设备数和会话数。thread 是官方当天独立对话数，不是 credits。设备+会话按客户端会话拆 thread；时段粘滞池把全天 thread 限制在约 24 条，并按 8 小时切开；完全收敛全天只有 1 条，单对话会极长，不建议共享号使用。',
        codexFingerprintOff: '关闭（透传）',
        codexFingerprintDevice: '仅设备',
        codexFingerprintSession: '设备+会话',
        codexFingerprintWindow: '时段粘滞池（推荐）',
