export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，将设备、会话和线程标识收敛为账号级稳定值。默认关闭，需要时再显式开启。40 Threads 时段池按 8 小时切换，每个 UTC 日最多 40 条，并按站内用户、API Key 和客户端会话稳定分槽；部分账号开启收敛后出现过额度缩水，请按自己的实测结果选择。',
