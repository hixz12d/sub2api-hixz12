-- Pinned-accounts Codex models manifest config for OpenAI groups.
-- Default '{}' keeps the feature disabled until an admin explicitly enables it.
-- Numbering skips 232-235 already used by local/custom migrations.
ALTER TABLE groups
