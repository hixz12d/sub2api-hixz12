...
func (a *gatewayAttemptTelemetry) recordForwardComplete(
	...
	fields = append(fields,
		...
		zap.Int("actual_proto_major", state.ActualProtoMajor),
		zap.Int("first_frame_ms", state.FirstFrameMs),
		zap.Int("first_semantic_ms", state.FirstSemanticMs),
		zap.Int("first_visible_ms", state.FirstVisibleMs),
		zap.String("failure_phase", state.FailurePhase),
		zap.String("failure_cause", state.FailureCause),
		zap.String("retry_decision_reason", state.RetryDecisionReason),
