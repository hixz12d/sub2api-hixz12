...
func RegisterAdminRoutes(
	...
	admin.Use(middleware.AdminComplianceGuard(settingService))
	{
		...
		registerBenchmarkRoutes(admin, h)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/client-profiles", h.Admin.Account.GetClientProfiles)
		accounts.POST("/client-profiles/:family/policy", h.Admin.Account.SetClientProfileUpdatePolicy)
		accounts.POST("/client-profile-preview", h.Admin.Account.PreviewClientProfile)
		accounts.GET("/:id/effective-client-profile", h.Admin.Account.GetEffectiveClientProfile)
		...
		accounts.GET("/:id/questions", h.Admin.Account.Questions)
		accounts.GET("/questions/:record/reviews", h.Admin.Account.QuestionHistory)
		accounts.POST("/questions/:record/reviews", h.Admin.Account.ReviewQuestion)
...
func registerOpenAIOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	openai := admin.Group("/openai")
	{
		...
		openai.GET("/accounts/:id/codex-analytics", h.Admin.OpenAIOAuth.QueryCodexAnalytics)
