...
// is immediately before native_compaction_v2; appended monitor columns do not move legacy positions.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	...
	// Legacy positions stay fixed when observation fields are appended.
	sessionArg := prepared.args[59]
	...
	require.Equal(t, "text", usageLogInsertArgTypes[59],
...
func TestPrepareUsageLogInsert_SessionIDNullWhenAbsent(t *testing.T) {
	...
	nsEmpty := preparedEmpty.args[59].(sql.NullString)
