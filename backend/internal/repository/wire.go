...
var ProviderSet = wire.NewSet(
	...
	NewMonitorJobRepository,
	NewBenchmarkRegistryRepository,
	NewQuestionReviewRepository,
	NewLLMDetectorRepository,
	NewChannelMonitorGroupRepository,
	wire.Bind(new(service.MonitorPolicyControl), new(*ChannelMonitorGroupRepository)),
	wire.Bind(new(service.DetectorTaskStore), new(*LLMDetectorRepository)),
	wire.Bind(new(service.DetectorTaskJobs), new(*MonitorJobRepository)),
	wire.Bind(new(service.QuestionReviewStore), new(*QuestionReviewRepository)),
	wire.Bind(new(service.BenchmarkRegistryStore), new(*BenchmarkRegistryRepository)),
	wire.Bind(new(service.MonitorJobStore), new(*MonitorJobRepository)),
	wire.Bind(new(service.MonitorProbeStore), new(*MonitorJobRepository)),
	wire.Bind(new(service.CapabilityStore), new(*MonitorJobRepository)),
