...
func TestCyberPolicyClientMessage(t *testing.T) {
	require.Equal(t, "flagged", cyberPolicyClientMessage(&Account{}, " flagged "))
	require.Equal(t, "Request blocked by upstream cyber-security policy", cyberPolicyClientMessage(nil, ""))
}
