...
const apiKeyAuthSnapshotVersion = 20 // v20: include group routing priority and media/search/audio pricing fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			OpenAIAccountPriorityMode:       apiKey.Group.OpenAIAccountPriorityMode,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			OpenAIAccountPriorityMode:       snapshot.Group.OpenAIAccountPriorityMode,
