...
func TestOpenAIGatewayService_ProxyResponsesWebSocketFromClient_TurnRetryForcesFreshConn(t *testing.T) {
	...
	staleConnB.handshakeCompatibility = normalizeOpenAIWSHandshakeCompatibilityForAccount(lastAcquire.Account, lastAcquire.Headers, lastAcquire.SessionScopeHash, lastAcquire.RouteKey, lastAcquire.TransportScopeKey)
