...
type CreatePaymentResponse struct {
	PayableAmountCents int64                   // PerPay's allocated amount, including the matching offset.
	ExpiresAt          time.Time               // Optional upstream checkout deadline.
