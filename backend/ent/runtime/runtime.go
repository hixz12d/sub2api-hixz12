...
func init() {
	...
	// groupDescOpenaiAccountPriorityMode is the schema descriptor for openai_account_priority_mode field.
	groupDescOpenaiAccountPriorityMode := groupFields[11].Descriptor()
	// group.DefaultOpenaiAccountPriorityMode holds the default value on creation for the openai_account_priority_mode field.
	group.DefaultOpenaiAccountPriorityMode = groupDescOpenaiAccountPriorityMode.Default.(string)
	// group.OpenaiAccountPriorityModeValidator is a validator for the "openai_account_priority_mode" field. It is called by the builders before save.
	group.OpenaiAccountPriorityModeValidator = groupDescOpenaiAccountPriorityMode.Validators[0].(func(string) error)
	...
	// usagelogDescRequestOrigin is the schema descriptor for request_origin field.
	usagelogDescRequestOrigin := usagelogFields[15].Descriptor()
	// usagelog.RequestOriginValidator is a validator for the "request_origin" field. It is called by the builders before save.
	usagelog.RequestOriginValidator = usagelogDescRequestOrigin.Validators[0].(func(string) error)
	// usagelogDescMonitorTpsMethod is the schema descriptor for monitor_tps_method field.
	usagelogDescMonitorTpsMethod := usagelogFields[22].Descriptor()
	// usagelog.MonitorTpsMethodValidator is a validator for the "monitor_tps_method" field. It is called by the builders before save.
	usagelog.MonitorTpsMethodValidator = usagelogDescMonitorTpsMethod.Validators[0].(func(string) error)
	// usagelogDescInputTokens is the schema descriptor for input_tokens field.
	usagelogDescInputTokens := usagelogFields[24].Descriptor()
	...
	usagelogDescOutputTokens := usagelogFields[25].Descriptor()
	...
	usagelogDescCacheCreationTokens := usagelogFields[26].Descriptor()
	...
	usagelogDescCacheReadTokens := usagelogFields[27].Descriptor()
	...
	usagelogDescCacheCreation5mTokens := usagelogFields[28].Descriptor()
	...
	usagelogDescCacheCreation1hTokens := usagelogFields[29].Descriptor()
