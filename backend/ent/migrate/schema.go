...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "openai_account_priority_mode", Type: field.TypeString, Size: 20, Default: "global"},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "request_origin", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "monitor_observation_version", Type: field.TypeInt, Nullable: true},
		{Name: "monitor_input_tokens_total", Type: field.TypeInt64, Nullable: true},
		{Name: "monitor_cache_read_tokens", Type: field.TypeInt64, Nullable: true},
		{Name: "monitor_visible_output_tokens", Type: field.TypeInt64, Nullable: true},
		{Name: "monitor_generation_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "monitor_output_tps_milli", Type: field.TypeInt64, Nullable: true},
		{Name: "monitor_tps_method", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "monitor_first_visible_ms", Type: field.TypeInt64, Nullable: true},
