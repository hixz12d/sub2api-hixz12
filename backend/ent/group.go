...
type Group struct {
	...
	// OpenAI 账号优先级来源：global=账号全局优先级，binding=当前分组绑定优先级
	OpenaiAccountPriorityMode string `json:"openai_account_priority_mode,omitempty"`
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldOpenaiAccountPriorityMode, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldOpenaiAccountPriorityMode:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field openai_account_priority_mode", values[i])
			} else if value.Valid {
				_m.OpenaiAccountPriorityMode = value.String
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("openai_account_priority_mode=")
	builder.WriteString(_m.OpenaiAccountPriorityMode)
	builder.WriteString(", ")
